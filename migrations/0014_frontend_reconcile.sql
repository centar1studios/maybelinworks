...
ADD COLUMN project_number INTEGER NOT NULL DEFAULT 0;
...
CREATE INDEX IF NOT EXISTS idx_projects_frontend_sort
ON projects (
    is_published,
    sort_order,
    project_number
