...
CREATE TABLE IF NOT EXISTS site_content (
    id INTEGER PRIMARY KEY
        CHECK (id = 1),
    site_nav_works_label TEXT NOT NULL
        DEFAULT 'EXPLORE WORKS',
    site_nav_about_label TEXT NOT NULL
        DEFAULT 'ABOUT',
    hero_tagline_top TEXT NOT NULL
        DEFAULT 'Work that looks good',
    hero_tagline_bottom TEXT NOT NULL
        DEFAULT 'does good',
    hero_video_url TEXT,
    works_label TEXT NOT NULL
        DEFAULT 'SELECTED WORKS',
    works_title TEXT NOT NULL
        DEFAULT 'Projects & Creative Works',
    works_intro TEXT
        DEFAULT 'A taste of the best.',
    about_label TEXT NOT NULL
        DEFAULT 'ABOUT',
    about_title TEXT NOT NULL
        DEFAULT 'MAYBELIN GARCIA ROMERO',
    about_text TEXT,
    about_photo_url TEXT,
    about_photo_alt TEXT
        DEFAULT 'Maybelin Garcia Romero',
    footer_brand TEXT NOT NULL
        DEFAULT 'Maybelin Works',
    footer_credit TEXT NOT NULL
        DEFAULT 'Website created by',
